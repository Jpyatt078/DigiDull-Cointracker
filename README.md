# DIGIDULL-Crypto-Tracker

Welcome to my GitHub repository for DIGIDULL Crypto Tracker$! This is a web application built with React and the CoinGecko API that allows users to track the prices of cryptocurrencies in real-time. The application is designed to help users stay up-to-date with the cryptocurrency market and make informed investment decisions. Below you will find some information on how to use and navigate this repository.
...
`git clone https://github.com/Jpyatt078/DigiDull-Cointracker.git`
